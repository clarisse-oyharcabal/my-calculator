def input_validator(number_1, operator, number_2):
    ...
    valid_sqrt_operator = True
    while operator == "r":
        if number_1 < 0:
            print("Square root operation is valid only for positive numbers.")
            valid_sqrt_operator = False
            return valid_sqrt_operator
        #sqrt_return = number_1, operator, None, valid_sqrt_operator # Retourner le nombre si pas d'erreur
        #return sqrt_return
        return number_1, operator, None, valid_sqrt_operator
    ...
    return number_1, operator, number_2, valid_number_1, valid_operator, valid_sqrt_operator, valid_division_operation, valid_number_2
